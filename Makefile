...
CMD = $(CC) -Os -c -Wall -Wno-unused-variable -Wno-strict-aliasing
APP = app_aditbox.elf
TTY = /dev/ttyACM0
...
app_nsd7451.elf: app_nsd7451.o
app_ps2kb1.elf: app_ps2kb1.o misc.o keyboard.o uskb.o
...
app_50hz.o: app_50hz.cpp
app_7seg1.o: app_7seg1.cpp
app_aditbox.o: app_aditbox.cpp analog.h button.h misc.h st7783.h tft.h uno.h
app_analog1.o: app_analog1.cpp misc.h uno.h
app_button1.o: app_button1.cpp misc.h uno.h
app_button2.o: app_button2.cpp misc.h uno.h
app_calc1.o: app_calc1.cpp misc.h analog.h button.h uno.h
app_calc2.o: app_calc2.cpp calc.h misc.h uno.h
...
app_kedei1.o: app_kedei1.cpp
app_ringtone1.o: app_ringtone1.cpp
app_ringtone2.o: app_ringtone2.cpp misc.h uno.h
...
arduino:
	avrdude -c arduino -p m328p -P $(TTY) -U $(APP)

download:
	avrdude -c stk500 -p m328p -P /dev/ttyUSB0 -U $(APP)
